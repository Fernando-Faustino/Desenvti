...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel ID="panelUsuariosCasastrados" runat="server" Visible="false">
            <br />
            ...
            <asp:Button ID="btnEnviarParabéns" runat="server" Text="Enviar Parabéns" OnClick="btnEnviarParabéns_Click1" />
